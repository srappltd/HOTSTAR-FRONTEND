  ...
  return (
    <div className='w-full'>
      ...
      <div className='w-full h-screen fixed'>
        <video src="" poster='https://img10.hotstar.com/image/upload/f_auto,q_90,w_1920/sources/r1/cms/prod/4473/1720972694473-i' className='w-full h-full object-cover'></video>
      </div>
      {/* // cover page top  */}
